...
// import wacc.backend.CodeGeneratorStateOld
// object CodeGeneratorOld {
//   // Compiles the program
//   def compileProgram(programNode: Program, codeGenState: CodeGeneratorStateOld)(
//       implicit instructions: mutable.ListBuffer[Instruction]
//   ): CodeGeneratorStateOld = {
...
//   def compileFunc(funcNode: Func, codeGenState: CodeGeneratorStateOld)(implicit
...
//   def compileParam(
//       paramNode: Param,
//       codeGenState: CodeGeneratorStateOld
//   ): CodeGeneratorStateOld = {
...
//   // Compiles expression
//   def compileExpression(exprNode: Expr, codeGenState: CodeGeneratorStateOld)(
//       implicit instructions: mutable.ListBuffer[Instruction]
//   ): CodeGeneratorStateOld = {
//     var newCodeGenState = codeGenState
...
//   def compileStat(statNode: Stat, codeGenState: CodeGeneratorStateOld)(implicit
//       instructions: mutable.ListBuffer[Instruction],
//       printTable: Map[(Int, Int), Type]
//   ): CodeGeneratorStateOld = {
//     var newCodeGenState = codeGenState
...
//   def compileIfStat(ifNode: If, codeGenState: CodeGeneratorStateOld)(implicit
//       instructions: mutable.ListBuffer[Instruction],
//       printTable: Map[(Int, Int), Type]
//   ): CodeGeneratorStateOld = {
...
//   def compileRValue(rValueNode: RValue, codeGenState: CodeGeneratorStateOld)(
//       implicit instructions: mutable.ListBuffer[Instruction]
//   ): CodeGeneratorStateOld = {
//     var newCodeGenState = codeGenState
...
//   def compileLValue(lValueNode: LValue, codeGenState: CodeGeneratorStateOld)(
//       implicit instructions: mutable.ListBuffer[Instruction]
//   ): CodeGeneratorStateOld = {
//     var newCodeGenState = codeGenState
//     lValueNode match {
...
//   private def compileIdent(ident: Ident, codeGenState: CodeGeneratorStateOld)(
//       implicit instructions: mutable.ListBuffer[Instruction]
//   ): CodeGeneratorStateOld = {
...
//   def compileNewPair(fst: Expr, snd: Expr, codeGenState: CodeGeneratorStateOld)(
//       implicit instructions: mutable.ListBuffer[Instruction]
//   ): CodeGeneratorStateOld = {
//     var newCodeGenState = codeGenState
